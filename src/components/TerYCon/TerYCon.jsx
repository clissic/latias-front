    ...
    <div className="text-white mt-5" id="tyc">
      ...
      <FadeIn>
        <section className="mb-5">
          ...
          <p>
            ...
            uso de la plataforma de educación en línea (en adelante, "la
            Plataforma") proporcionada por{" "}
            <strong>[Nombre de la Empresa]</strong>, con domicilio en{" "}
            <strong>[Dirección]</strong>, Uruguay. Al acceder o utilizar la
            Plataforma, usted (en adelante, "el Usuario") acepta cumplir con
            estos Términos.
          </p>
        </section>
      </FadeIn>
      ...
      <FadeIn>
        <section className="mb-5">
          ...
          <ul>
            <li>
              <strong>Elegibilidad:</strong> El Usuario debe ser mayor de 18
              años. Los menores de edad requieren autorización de un padre o
              tutor legal.
            </li>
            <li>
              <strong>Cuenta Personal:</strong> El Usuario debe proporcionar
              información veraz y mantener la confidencialidad de sus
      ...
      <FadeIn>
        <section className="mb-5">
          ...
          <ul>
            <li>
              <strong>Licencia de Uso:</strong> Se otorga al Usuario una
              licencia limitada, no exclusiva e intransferible para acceder a
              los cursos adquiridos.
            </li>
            <li>
      ...
      <FadeIn>
        <section className="mb-5">
          ...
          <ul>
            <li>
              <strong>Precios:</strong> Los precios de los cursos se indican en
              la Plataforma y pueden estar sujetos a impuestos según la
              normativa uruguaya.
            </li>
            <li>
              <strong>Formas de Pago:</strong> Se aceptan pagos mediante
              tarjetas de crédito/débito y otros métodos especificados en la
              Plataforma.
            </li>
            <li>
      ...
      <FadeIn>
        <section className="mb-5">
          ...
          <p>
            ...
            solicitar una constancia de participación, pero no se emitirá un
            nuevo certificado.
          </p>
        </section>
      </FadeIn>
      <FadeIn>
        <section className="mb-5">
          ...
          <p>
            ...
            <strong>[Nombre de la Empresa]</strong> o de sus licenciantes y
        ...
        <section className="mb-5">
          ...
          <ul>
            ...
            <li>
              ...
              contenido que el Usuario publique en la Plataforma no debe
              infringir derechos de terceros ni contener material ofensivo o
              ilegal.
            </li>
          </ul>
        </section>
      ...
      <FadeIn>
        <section className="mb-5">
          ...
          <p>
            <strong>[Nombre de la Empresa]</strong> no será responsable por
            daños directos o indirectos derivados del uso de la Plataforma,
            incluyendo, pero no limitado a, interrupciones del servicio, errores
            o pérdida de datos.
          </p>
        </section>
      </FadeIn>
      ...
      <FadeIn>
        <section className="mb-5">
          ...
          <p>
            ...
            Uruguay. Cualquier disputa derivada de estos Términos será sometida
            a la jurisdicción de los tribunales competentes en Montevideo,
            Uruguay.
          </p>
        </section>
      </FadeIn>
